<div class="container mt-5">
    ...
    <form action="index.php?uc=genres&action=validerForm" method="post"
        ...
        <div class="form-group">
            ...
            <input type="text" class='form-control' id='libelle' placehoder='Saisir le libellé' name='libelle'
                value="<?php if($action == "Modifier") {echo $leGenre->getLibelle() ;} ?>">
        </div>
        <input type="hidden" id="num" name="num" value="<?php if($action == "Modifier") {echo $leGenre->getNum();} ?>">
        <div class="row">
